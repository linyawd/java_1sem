Я відповім як досвідчений розробник Java, який багато років пише і перевіряє імітаційні моделі систем масового обслуговування.

**TL;DR**: Нижче повний робочий клас `B09_02` з методом `main`, який читає вхідні дані, моделює роботу готелю та виводить середній час очікування.
